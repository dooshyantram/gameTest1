  $(function(){
                  ...
                  function check_dist() {
                       ...
                       if (dist == ""){
                         $("#dist_er").html("A district should be selected");
                          ...
                          $("#dist").css("border-bottom","2px solid red")
                          err_dist = true;
                           ...
                           $("#dist_er").hide();
                           $("#dist").css("border-bottom","2px solid green");
                  ...
                  function check_pass() {
                    ...
                    var cpass = $("#cpass").val(); 
                      ...
                      function check_uname() {
                       ...
                       if (uname =="admin" && uname != null){
                        $("#uname_er").hide();
                        $("#uname").css("border-bottom","2px solid green");
                        err_uname = false;


                       }else if(uname == null){
                           
                           $("#uname").css("border-bottom","2px solid red");
                           err_uname = true;
                       }

                       else{
                        $("#uname_er").html("Wrong Username");
                          $("#uname_er").show('slow').delay(3000).hide('slow');
                          $("#uname").css("border-bottom","2px solid red");
                          err_uname = true; 
                       }
                   ...
                   function check_passw() {
                        ...
                        var passw = $("#passw").val();
                       if (passw ==="admin" && passw != null){
                        $("#passw_er").hide();
                        $("#passw").css("border-bottom","2px solid green");
                        err_passw = false;
                       

                      }else if(passw == ''){
                          
                           $("#passw").css("border-bottom","2px solid red");
                           err_passw = true;

                       }
                       else{
                          $("#passw_er").html("Wrong Password");
                         $("#passw_er").show('slow').delay(3000).hide('slow');
                         $("#passw").css("border-bottom","2px solid red")
                          err_passw = true; 
                         ...
                         $("#pop").click(function(){
                            ...
                            if(err_uname == false && err_passw == false){
